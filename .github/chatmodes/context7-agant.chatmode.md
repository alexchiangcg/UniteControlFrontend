...
tools: ['vscode', 'execute/runNotebookCell', 'execute/testFailure', 'execute/getTerminalOutput', 'execute/runTask', 'execute/getTaskOutput', 'execute/createAndRunTask', 'execute/runInTerminal', 'read', 'edit', 'search', 'web', 'context7/*', 'deepwiki/*', 'figma-dev-mode/*', 'spec-workflow/*', 'com.figma.mcp/mcp/*', 'agent', 'todo']
---
