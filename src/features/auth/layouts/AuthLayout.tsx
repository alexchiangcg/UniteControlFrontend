...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    <div className="flex min-h-screen bg-gray-100 w-full font-['Inter',sans-serif]">
      {/* 左側滿版圖片與說明框 */}
      <div className="hidden md:flex md:w-1/2 h-screen relative flex-col justify-center items-center">
        ...
        />
        {/* 說明框 */}
        <div className="relative z-10 w-full max-w-[504px] mx-auto bg-gray-500 rounded opacity-90 p-4">
